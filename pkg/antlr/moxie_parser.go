...
func (s *SourceFileContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
...
func (s *Tag_Context) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterTag_(s)
	}
}

func (s *Tag_Context) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitTag_(s)
	}
}
...
func (s *InterfaceElemContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterInterfaceElem(s)
	}
}

func (s *InterfaceElemContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitInterfaceElem(s)
	}
}
...
func (s *MethodElemContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterMethodElem(s)
	}
}

func (s *MethodElemContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitMethodElem(s)
	}
}
...
func (s *SendRecvChanContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSendRecvChan(s)
	}
}

func (s *SendRecvChanContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSendRecvChan(s)
	}
}
...
func (s *SendRecvChanCompatContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSendRecvChanCompat(s)
	}
}

func (s *SendRecvChanCompatContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSendRecvChanCompat(s)
	}
}
...
func (s *RecvOnlyChanContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterRecvOnlyChan(s)
	}
}

func (s *RecvOnlyChanContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitRecvOnlyChan(s)
	}
}
...
func (s *RecvOnlyChanCompatContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterRecvOnlyChanCompat(s)
	}
}

func (s *RecvOnlyChanCompatContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitRecvOnlyChanCompat(s)
	}
}
...
func (s *FallthroughStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterFallthroughStatement(s)
	}
}

func (s *FallthroughStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitFallthroughStatement(s)
	}
}
...
func (s *GoStatementContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterGoStatement(s)
	}
}

func (s *GoStatementContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitGoStatement(s)
	}
}
...
func (s *ConcatenationExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterConcatenationExpr(s)
	}
}

func (s *ConcatenationExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitConcatenationExpr(s)
	}
}
...
func (s *TypeAssertionExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterTypeAssertionExpr(s)
	}
}

func (s *TypeAssertionExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitTypeAssertionExpr(s)
	}
}
...
func (s *ConversionExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterConversionExpr(s)
	}
}

func (s *ConversionExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitConversionExpr(s)
	}
}
...
func (s *PrimaryOperandContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterPrimaryOperand(s)
	}
}

func (s *PrimaryOperandContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitPrimaryOperand(s)
	}
}
...
func (s *SliceCastCopyEndianExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSliceCastCopyEndianExpr(s)
	}
}

func (s *SliceCastCopyEndianExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSliceCastCopyEndianExpr(s)
	}
}
...
func (s *SliceCastCopyExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSliceCastCopyExpr(s)
	}
}

func (s *SliceCastCopyExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSliceCastCopyExpr(s)
	}
}
...
func (s *SimpleConversionContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSimpleConversion(s)
	}
}

func (s *SimpleConversionContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSimpleConversion(s)
	}
}
...
func (s *SliceCastExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSliceCastExpr(s)
	}
}

func (s *SliceCastExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSliceCastExpr(s)
	}
}
...
func (s *SliceCastEndianExprContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterSliceCastEndianExpr(s)
	}
}

func (s *SliceCastEndianExprContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitSliceCastEndianExpr(s)
	}
}
...
func (s *EndiannessContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterEndianness(s)
	}
}

func (s *EndiannessContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitEndianness(s)
	}
}
...
func (s *NameOperandContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.EnterNameOperand(s)
	}
}

func (s *NameOperandContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(MoxieListener); ok {
		listenerT.ExitNameOperand(s)
	}
}
